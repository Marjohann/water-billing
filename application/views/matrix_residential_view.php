...
<div class="static-content"  >
    <div class="page-content"><!-- #page-content -->
        ...
        <ol class="breadcrumb" style="margin:0;">
            ...
            <li><a href="Matrix_residential">Residential Rate Matrix</a></li>
        </ol>
        <div class="container-fluid">
            <div data-widget-group="group1">
                <div class="row">
                    <div class="col-md-12">
                        <div id="div_chart_list">
                            ...
                            <h2 class="h2-panel-heading">Residential Rate Matrix</h2><hr>
                ...
                <table id="table_hidden" class="hidden">
                    <tr>
                        <td><input type="text" name="matrix_residential_from[]" class="form-control number" required data-error-msg="Range From is required!"></td>
                        <td><input type="text" name="matrix_residential_to[]" class="form-control number" required data-error-msg="Range To is required!"></td>
                        <td><input type="text" name="matrix_residential_amount[]" class="form-control numeric" required data-error-msg="Rate Amount is required!"></td>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_matrixes').DataTable({
            ...
            "pageLength": 15,
                "order": [[ 1, "desc" ]],
            "ajax" : "Matrix_residential/transaction/list",
            "columns": [
                { 
                    "targets": [0],
                ...
                { targets:[1],data: "matrix_residential_code" },
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_matrixes tbody').on( 'click', 'tr td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                $.ajax({
                    "dataType":"html",
                    "type":"POST",
                    "url":"Templates/layout/residential-matrix/"+ d.matrix_residential_id,
                    "beforeSend" : function(){
        ...
        $('#btn_new').click(function(){
            _txnMode="new";
            $('#account_add_title').text('New Residential Rate Matrix');
        ...
        $('#tbl_matrixes tbody').on('click','button[name="edit_info"]',function(){
            ...
            _selectedID=data.matrix_residential_id;
            ...
            $('#account_add_title').text('Edit Residential Rate Matrix');


            $.ajax({
                url : 'Matrix_residential/transaction/edit-items/'+data.matrix_residential_id,
                type : "GET",
                cache : false,
                dataType : 'json',
                processData : false,
                ...
                success : function(response){
                    ...
                    $.each(rows,function(i,value){
                        $('#tbl_matrix_form > tbody').append(newRowItem({
                            matrix_residential_from : value.matrix_residential_from,
                            matrix_residential_to : value.matrix_residential_to,
                            matrix_residential_amount : value.matrix_residential_amount,
    ...
    var createAccountInfo=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Matrix_residential/transaction/create",
            "data":_data,
    ...
    var updateAccountInfo=function(){
        ...
        var _data=$('#frm_accounts').serializeArray();
        _data.push({name : "matrix_residential_id" ,value : _selectedID});
        console.log(_data)
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Matrix_residential/transaction/update",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
    ...
    var removeAccount=function(){
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Matrix_residential/transaction/delete",
            "data":{matrix_residential_id : _selectedID}
        });
    };
    ...
    var newRowItem=function(d){
        return '<tr>'+
        //DISPLAY
        '<td  style=""><input name="matrix_residential_from[]" type="text" class="number form-control" value="'+ accounting.formatNumber(d.matrix_residential_from,0)+'"></td>'+
        '<td  style=""><input name="matrix_residential_to[]" type="text" class="number form-control" value="'+ accounting.formatNumber(d.matrix_residential_to,0)+'"></td>'+
        '<td  style=""><input name="matrix_residential_amount[]" type="text" class="numeric form-control" value="'+ accounting.formatNumber(d.matrix_residential_amount,2)+'"></td>'+

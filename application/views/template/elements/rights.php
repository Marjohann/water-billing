	<script>
        ...
        // ## Institutional Rate Matrix
        var btn_edit_institutional_rate='<button class="btn btn-primary btn-sm" name="edit_info"  style="margin-left:-15px;" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i> </button>';
        var btn_trash_institutional_rate='<button class="btn btn-red btn-sm" name="remove_info" style="margin-right:0px;" data-toggle="tooltip" data-placement="top" title="Move to trash"><i class="fa fa-trash-o"></i> </button>';
	</script>
...
<?php
    ...
    // ## Institutional Rate Matrix
    echo (in_array('40-1',$this->session->user_rights)? '' : '<script> $(".create_institutional_rate").remove(); </script>');
    echo (in_array('40-2',$this->session->user_rights)? '' : '<script> var btn_edit_institutional_rate=""; </script>');
    echo (in_array('40-3',$this->session->user_rights)? '' : '<script> var btn_trash_institutional_rate=""; </script>');           
?>
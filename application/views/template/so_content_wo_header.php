    ...
    <center>
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11">
            ...
            <tr>
                ...
                <th width="12%" style="border-bottom: 2px solid gray;text-align: right;height: 15px;padding: 6px;">Total</th>
            </tr>
            </thead>
            <tbody>
            ...
            <?php } ?>
                ...
                <tr>
                <td colspan="5" style="text-align: left;font-weight: bolder; ;height: 15px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;"><?php echo $sales_order->remarks; ?></td>
                </tr>
            </tbody>
            <tfoot>
            <tr>

...
<ul class="nav nav-tabs">
    <li class="active"><a href="#journal_review_<?php echo $info[0]->billing_penalty_id; ?>" data-toggle="tab"><i class="fa fa-gavel"></i> Review Journal</a></li>
    <li class=""><a href="#purchase_review_<?php echo $info[0]->billing_penalty_id; ?>" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Transaction</a></li>
</ul>
<div class="tab-content">
<div class="tab-pane active" id="journal_review_<?php echo $info[0]->billing_penalty_id; ?>" data-parent-id="<?php echo $info[0]->billing_penalty_id; ?>" style="min-height: 300px;">


    <form id="frm_journal_review" role="form" class="form-horizontal row-border">
        <h4><span style="margin-left: 1%"><strong><i class="fa fa-gear"></i> Billing Penalty Information</strong></span></h4>
        <hr />
        <div style="width: 90%;">
            <input type="hidden" name="billing_penalty_id" value="<?php echo $info[0]->billing_penalty_id; ?>">
        ...
        <hr />
        <table id="tbl_entries_for_review_<?php echo $info[0]->billing_penalty_id; ?>" class="table table-striped" style="width: 100% !important;">
            <thead>
...
<div class="tab-pane" id="purchase_review_<?php echo $info[0]->billing_penalty_id; ?>" >
    <h4><span style="margin-left: 1%"><strong><i class="fa fa-bars"> </i> Penalty Details</strong></span></h4>
    <hr />
    ...
    <thead>
        <tr>
            ...
            <th style="">Meter Serial</th>
            <th style="">Particular</th>
            <th class="right_align">Penalty Amount</th>
        </tr>
    </thead>
    <tbody>
    <?php $total_amount=0;
    foreach ($items as $item) { 
        $total_amount+= $item->penalty_fee;
        ?>
        <tr>
            <td><?php echo $item->account_no ?></td>
            <td><?php echo $item->serial_no ?></td>
            <td><?php echo $item->receipt_name ?></td>
            <td class="right_align"><?php echo number_format($item->penalty_fee,2); ?></td>
        </tr>
    <?php } ?>
    </tbody>
    <tfoot>
        <tr>
            ...
            <td class="right_align"><b><?php echo number_format($total_amount,2); ?><b></td>
        </tr>
    </tfoot>
</table>
        <br /><br />

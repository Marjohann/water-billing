...
<html>
<head>
    <title>Institutional Rate Matrix</title>
<style>
    body {
...
<body>
    ...
    <h3 class="report-header"><strong>Instituional Rate Matrix</strong></h3>
    <table width="100%" border="0" cellspacing="-1">
        <tr>
            <td style="padding: 4px;" width="50%"><strong>Matrix Code: </strong> <?php echo $info[0]->matrix_institutional_code; ?></td>
    ...
    <table width="100%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11" border="0">
            ...
            foreach($items as $item){
                ...
                ?>
                <tr>
                    <td width="15%" style="border: 1px solid gray;text-align: left;height: 30px;padding: 6px;"><?php echo number_format($item->matrix_institutional_from,0); ?></td>
                    <td width="15%" style="border: 1px solid gray;text-align: left;height: 30px;padding: 6px;"><?php echo number_format($item->matrix_institutional_to,0); ?></td>
                    <td width="15%" style="border: 1px solid gray;text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->matrix_institutional_amount,2); ?></td>

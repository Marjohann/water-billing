                                                    ...
                                                    <table id="tbl_items" class="table table-striped" cellspacing="0" width="100%" style="font-font:tahoma;">
                                                        <thead class="">    
                                                            <tr>        
                                                                ...
                                                                <th>Description</th>
                                                                <th>Due Date</th>                                                   
                                                                <th width="13%" style=>Amount Due</th>
                                                                <th width="13%" style="text-align: right;">Other Charges/Meter Loan</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var bindEventHandlers=(function(){
           ...
           $.ajax({
            ...
            $('#tbl_items > tbody').on('click','button.btn_set_amount',function(e){
                ...
                var other_charges=getFloat(row.find('input[name="charges_amount[]"]').val());
                row.find('input[name="payment_amount[]"]').val(accounting.formatNumber((payableAmount+other_charges),2));
                reComputeDetails();
            });
            ...
            $('#tbl_items > tbody').on('keyup','input.numeric',function(e){
                ...
                if((payment == other_charges)>payable){
                    showNotification({
                        "title": "Invalid!",
                        "stat" : "error",
        ...
        var reComputeDetails=function(){
            ...
            $.each(rows,function(i,value){
                ...
                total_payable+=getFloat(row.find('input[name="charges_amount[]"]').val());
            ...
            $('input[name="total_paid_amount"]').val(accounting.formatNumber((total_payment+other_charges+total_deposit),2)); // THE SUM OF THE FOUR ABOVE
    ...
    var newRowItem=function(d){
        ...
        '<td><input name="charges_amount[]" type="text" class="numeric form-control" value="'+d.other_charges+'" readonly></td>'+

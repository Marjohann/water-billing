      ...
      <div class="lg-info-panel">
          <div class="inner-panel">
              <div class="lg-content">
                  ...
                  <hr><h2 style="font-family: sans-serif!important; color: white;"><b>GARCIA - HERNANDEZ </b><br>  WATER BILLING AND PAYMENT 2022</h2><hr>
                  <h3 style="color: #03a9f4;"><?php echo $company_info[0]->company_name; ?></h3>
                  <span style="position: absolute; bottom: -3%; right: 1%;"><p>powered by: SPOOGO IT SOLUTIONS INC.</p></span>
              </div>
          </div>
      </div>

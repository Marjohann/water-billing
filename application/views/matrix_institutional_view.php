...
<div class="static-content"  >
    <div class="page-content"><!-- #page-content -->
        ...
        <ol class="breadcrumb" style="margin:0;">
            ...
            <li><a href="Matrix_institutional">Institutional Rate Matrix</a></li>
        </ol>
        <div class="container-fluid">
            <div data-widget-group="group1">
                <div class="row">
                    <div class="col-md-12">
                        <div id="div_chart_list">
                            ...
                            <h2 class="h2-panel-heading">Institutional Rate Matrix</h2><hr>
                                ...
                                <div class="row" id="treeListWrapper">
                                    <div class="col-xs-12 col-lg-12">
                                        <div class="panel-body table-responsive" style="padding-left: 1px!important;border-top-color:transparent!important;">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <button class="btn btn-primary create_institutional" id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="New Matrix" ><i class="fa fa-plus"></i> New Matrix</button>
                                                </div>
                                                <div class="col-sm-3">
                                                </div>
                                                <div class="col-sm-3">
                ...
                <table id="table_hidden" class="hidden">
                    <tr>
                        <td><input type="text" name="matrix_institutional_from[]" class="form-control number" required data-error-msg="Range From is required!"></td>
                        <td><input type="text" name="matrix_institutional_to[]" class="form-control number" required data-error-msg="Range To is required!"></td>
                        <td><input type="text" name="matrix_institutional_amount[]" class="form-control numeric" required data-error-msg="Rate Amount is required!"></td>
...
<footer role="contentinfo">
    <div class="clearfix">
        <ul class="list-unstyled list-inline pull-left">
            <li><h6 style="margin: 0;">&copy; 2022 - SPOOGO IT SOLUTIONS INC.</h6></li>
        </ul>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_matrixes').DataTable({
            ...
            "pageLength": 15,
                "order": [[ 1, "desc" ]],
            "ajax" : "Matrix_institutional/transaction/list",
            "columns": [
                { 
                    "targets": [0],
                ...
                { targets:[1],data: "matrix_institutional_code" },
                { targets:[2],data: "description" },
                { targets:[3],data: "other_details" },
                {
                    targets:[4],
                    render: function (data, type, full, meta){
                        return '<center>'+btn_edit_institutional_rate+'&nbsp;'+btn_trash_institutional_rate+'</center>';
                    }
                }
            ]
        });
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_matrixes tbody').on( 'click', 'tr td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                $.ajax({
                    "dataType":"html",
                    "type":"POST",
                    "url":"Templates/layout/institutional-matrix/"+ d.matrix_institutional_id,
                    "beforeSend" : function(){
        ...
        $('#btn_new').click(function(){
            _txnMode="new";
            $('#account_add_title').text('New Institutional Rate Matrix');
        ...
        $('#tbl_matrixes tbody').on('click','button[name="edit_info"]',function(){
            ...
            _selectedID=data.matrix_institutional_id;
            ...
            $('#account_add_title').text('Edit Institutional Rate Matrix');


            $.ajax({
                url : 'Matrix_institutional/transaction/edit-items/'+data.matrix_institutional_id,
                type : "GET",
                cache : false,
                dataType : 'json',
                processData : false,
                ...
                success : function(response){
                    ...
                    $.each(rows,function(i,value){
                        $('#tbl_matrix_form > tbody').append(newRowItem({
                            matrix_institutional_from : value.matrix_institutional_from,
                            matrix_institutional_to : value.matrix_institutional_to,
                            matrix_institutional_amount : value.matrix_institutional_amount,
    ...
    var createAccountInfo=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Matrix_institutional/transaction/create",
            "data":_data,
    ...
    var updateAccountInfo=function(){
        ...
        var _data=$('#frm_accounts').serializeArray();
        _data.push({name : "matrix_institutional_id" ,value : _selectedID});
        console.log(_data)
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Matrix_institutional/transaction/update",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
    ...
    var removeAccount=function(){
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Matrix_institutional/transaction/delete",
            "data":{matrix_institutional_id : _selectedID}
        });
    };
    ...
    var newRowItem=function(d){
        return '<tr>'+
        //DISPLAY
        '<td  style=""><input name="matrix_institutional_from[]" type="text" class="number form-control" value="'+ accounting.formatNumber(d.matrix_institutional_from,0)+'"></td>'+
        '<td  style=""><input name="matrix_institutional_to[]" type="text" class="number form-control" value="'+ accounting.formatNumber(d.matrix_institutional_to,0)+'"></td>'+
        '<td  style=""><input name="matrix_institutional_amount[]" type="text" class="numeric form-control" value="'+ accounting.formatNumber(d.matrix_institutional_amount,2)+'"></td>'+

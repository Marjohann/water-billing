                                                    ...
                                                    <h2 class="h2-panel-heading">Meter Inventory</h2><hr>
                                                         ...
                                                         <div class="row">
                                                            <div class="col-lg-3"><br>
                                                                    <button class="btn btn-primary create_meter_inventory" id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;margin-bottom: 0px !important; float: left;" data-toggle="modal" data-target="" data-placement="left" title="New Meter" ><i class="fa fa-plus"></i>  New Meter</button>
                                                            </div>
                ...
                "columns": [
                    ...
                    { targets:[4],data: "status_name" },
                    {
                        ...
                        render: function (data, type, full, meta){
                            return '<center>'+btn_edit_meter_inventory+'&nbsp;'+btn_trash_meter_inventory+'</center>';
                        }
                    },

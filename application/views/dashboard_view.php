                                    ...
                                    <div class="col-md-12" >
                                        <div class="panel panel-default" style="overflow-x: hidden!important;"> 
                                            <div class="panel-body table-responsive" style="border-top-color: white!important;">
                                                ...
                                                <h1 ><b class="ti ti-bar-chart-alt"  style="color:#067cb2;"></b> <strong style="color:#067cb2;">SPOOGO</strong> IT SOLUTIONS INC.</h1>
                                                <div id="intro">
                                                    <h4 class="welcome-msg" style="word-wrap: break-word;padding-left: 0px;padding-right: 0px;">Hi
                                                        ...
                                                        </b> here is a rundown of your waterworks <br>performance and how your collections are doing individually. 
                                                    </h4>
                                                </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="data-container text-center text-container">
                                                            <h2><strong><?php echo ($this->session->user_group_id != 2 ? '0.00' : number_format($receivables->Balance,2)); ?></strong></h2>
                                                            <h4><b>Accounts Receivables</b></h4>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="data-container text-center text-container">
                                                            <h2><strong><?php echo ($this->session->user_group_id != 2 ? '0.00' : number_format($payables->Balance,2)); ?></strong></h2>
                                                            <h4><b>Accounts Payables</b></h4>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="data-container text-center text-container">
                                                            <h2><strong><?php echo ($this->session->user_group_id != 2 ? '0' : $customer_count); ?></strong></h2>
                                                            <h4><b>Customers</b></h4>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="data-container text-center text-container">
                                                            <h2><strong><?php echo ($this->session->user_group_id != 2 ? '0' : $suppliers_count); ?></strong></h2>
                                                            <h4><b>Suppliers</b></h4>
                                                        </div>
                                                    </div>
                                                </div>

    ...
    function transaction($txn = null,$id_filter=null) {
        switch ($txn){
            ...
            case 'create-batch':
                ...
                $m_invoice->batch_no  = 'BCH-'.$batch_info->meter_reading_year.''.$month_id.'-'.$batch_id.'-'.$m_invoice->remarks;
                $m_invoice->save();
                ...
                if($m_invoice->status()===TRUE){
                    ...
                    $m_trans->trans_log='Created New Batch Meter Reading: BCH-'.$batch_info->meter_reading_year.''.$month_id.'-'.$batch_id.'-'.$m_invoice->remarks;
                    $m_trans->save();

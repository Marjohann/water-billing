...
class Batch_payments_report extends CORE_Controller {
    ...
    function response_rows($billing_payment_batch_id=null){ 
        return $this->Billing_payments_model->get_list(array('billing_payment_batch_id'=>$billing_payment_batch_id,'billing_payments.is_active'=>TRUE,'billing_payments.is_deleted'=>FALSe),
            'billing_payments.*,payment_methods.payment_method,customers.customer_name,customers.address,service_connection.account_no,service_connection.receipt_name,service_connection.address,CONCAT_WS(" ",user_accounts.user_fname,user_accounts.user_lname)as posted_by_user
            ',
